...
class MuSRDataset:
    ...
    def __init__(self, data_split: List[str] = ["murder_mysteries", "object_placements", "team_allocation"]):
        self.dataset = []
        for split in data_split:
            self.dataset.extend(MsDataset.load("AI-ModelScope/MuSR", split=split, trust_remote_code=True))
